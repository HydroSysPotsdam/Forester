...
class Database:
    ...
    def __init__(self, directory, table_name="projects", delete_unlinked=True) -> None:
        ...
        # add the directory if it not already exists
    ...
    def load_examples(self, directory="../../examples", reload=False):
        """
